...
export default function EducationModal({ open, onClose, education }: Props) {
  ...
  const { mutate: updateEducation, isPending: isUpdatingEducation } =
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-sm">
          <div className="flex flex-col gap-1">
            ...
            <Input
              ...
              {...register('schoolName', {
                ...
                validate: (value) =>
                  value.trim().length > 0 || 'School name is required,',
              })}
            />
            {errors.schoolName && (
            ...
            <Input
              ...
              {...register('country', {
                validate: (value) =>
                  !value ||
                  value.trim().length >= 2 ||
                  'Country must be atleast 2 characters long.',
              })}
            />
            {errors.country && (
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button
              type="submit"
              disabled={isAddingEducation || isUpdatingEducation}
            >
              {isAddingEducation || isUpdatingEducation ? 'Saving...' : 'Save'}
            </Button>
          </div>
        </form>
      </div>
